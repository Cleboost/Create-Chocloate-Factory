package fr.cleboost.createchocolatefactory.entity.custom;

import fr.cleboost.createchocolatefactory.entity.ModEntities;
...
public class ModChestBoatEntity extends ChestBoat {
    ...
    public ModChestBoatEntity(Level pLevel, double pX, double pY, double pZ) {
        this((EntityType<? extends ChestBoat>) ModEntities.MOD_CHEST_BOAT.get(), pLevel);
