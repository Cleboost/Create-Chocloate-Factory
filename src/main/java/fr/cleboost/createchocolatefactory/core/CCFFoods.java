...
public class CCFFoods {
    ...
    public static final FoodProperties BROWN_CHOCOLATE = new FoodProperties.Builder().nutrition(4)
            .saturationModifier(0.2f).effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 200), 0.3f).build();
    ...
    public static final FoodProperties COCOA_BUTTER = new FoodProperties.Builder().saturationModifier(0.2f).nutrition(6).build();
    public static final FoodProperties CHOCOLATE_BAR = new FoodProperties.Builder().nutrition(4).saturationModifier(0.2f).build();
}
