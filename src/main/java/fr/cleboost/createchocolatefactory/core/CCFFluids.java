...
public class CCFFluids {
    ...
    public static final FluidEntry<VirtualChocolateFluid> CHOCOLATE =
            REGISTRATE.virtualFluid("chocolate", VirtualChocolateFluid.ChocolateFluidType::new,VirtualChocolateFluid::createSource,VirtualChocolateFluid::createFlowing)
