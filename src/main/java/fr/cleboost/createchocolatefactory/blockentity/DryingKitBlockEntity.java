...
public class DryingKitBlockEntity extends BlockEntity implements TickableBlockEntity, IHaveGoggleInformation {
    ...
    public boolean addToGoggleTooltip(List<Component> tooltip, boolean isPlayerSneaking) {
        ...
        tooltip.add(Component.literal(spacing)
                .append(Component.translatable(CreateChocolateFactory.MODID + ".tooltip.dryingkit.info")
                        .withStyle(ChatFormatting.WHITE)));

        if (level.dimension().equals(Level.NETHER)) {
            tooltip.add(Component.literal(spacing + "  ")
                    .append(Component.translatable(CreateChocolateFactory.MODID + ".tooltip.dryingkit.bonus")
                            .withStyle(ChatFormatting.GOLD)));
            tooltip.add(Component.literal(spacing + "    ")
                    .append(Component.translatable(CreateChocolateFactory.MODID + ".tooltip.dryingkit.bonus_text")
        ...
        switch (state) {
            case DRYING:
                stateComponent = Component.translatable(CreateChocolateFactory.MODID + ".tooltip.dryingkit.drying")
                        .withStyle(ChatFormatting.AQUA);
                break;
            case DRY:
                stateComponent = Component.translatable(CreateChocolateFactory.MODID + ".tooltip.dryingkit.dry")
                        .withStyle(ChatFormatting.GREEN);
                break;
            default:
                stateComponent = Component.translatable(CreateChocolateFactory.MODID + ".tooltip.dryingkit.empty")
                        .withStyle(ChatFormatting.AQUA);
                break;
        }
        tooltip.add(Component.literal(spacing)
        ...
        if (state == DryingKitBlock.State.DRYING) {
            ...
            if (!level.canSeeSky(worldPosition) && !level.dimension().equals(Level.NETHER)) {
                tooltip.add(Component.literal(spacing)
                        .append(Component.translatable(CreateChocolateFactory.MODID + ".tooltip.dryingkit.blocked_sky")
                                .withStyle(ChatFormatting.RED)));
            } else if (!level.isDay() && !level.dimension().equals(Level.NETHER)) {
                tooltip.add(Component.literal(spacing)
                        .append(Component.translatable(CreateChocolateFactory.MODID + ".tooltip.dryingkit.night")
                                .withStyle(ChatFormatting.DARK_GRAY)));
            } else if (level.isRaining() || level.isThundering()) {
                tooltip.add(Component.literal(spacing)
                        .append(Component.translatable(CreateChocolateFactory.MODID + ".tooltip.dryingkit.raining")
                                .withStyle(ChatFormatting.DARK_GRAY)));
            }
        }
