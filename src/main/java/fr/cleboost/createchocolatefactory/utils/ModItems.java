...
public class ModItems {
    ...
    public static final DeferredItem<Item> COCOA_BEANS_WET = ITEMS.register("cocoa_beans_wet",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> COCOA_BEANS_DIRTY = ITEMS.register("cocoa_beans_dirty",
            () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> COCOA_BEANS_ROASTED = ITEMS.register("cocoa_beans_roasted",
            () -> new Item(new Item.Properties()));
